...
<div class="container mt-5 mb-5">
    ...
    <div class="card shadow-lg border-0">
        ...
        <div class="card-header  text-white" style="background-color: #2b50aa;>
            <h3 class="mb-0">
                {{ $guardians['first_name'] }} {{ $guardians['last_name'] }}
            </h3>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-control text-muted">
                        {{ \Carbon\Carbon::parse($guardians['created_at'])->format('d/m/Y H:i') }}
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-control text-muted">
                        {{ \Carbon\Carbon::parse($guardians['updated_at'])->format('d/m/Y H:i') }}
                    </div>
                </div>
